...
if (reduce) {
  ...
  if (hero) {
    ...
    tl.to(owl, { opacity: 1, scale: 1, duration: 0.6, ease: "power3.out" })
      ...
      .from(".hero-copy h1", { y: 26, opacity: 0, duration: 0.7 }, "-=0.2")
      .from(".hero-copy .lede", { y: 18, opacity: 0, duration: 0.6 }, "-=0.45")
      .from(".hero-copy .hero-cta", { y: 14, opacity: 0, duration: 0.55 }, "-=0.4")
      .from(win, { y: 34, opacity: 0, scale: 0.985, duration: 0.8 }, "-=0.65");
